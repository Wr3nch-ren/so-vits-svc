...
<head>
    ...
    <script type="module" src="js/waveform.js"></script>
...
<body>
    ...
    <div class="container my-5">
        <div class="row p-4 pt-lg-5 align-items-center rounded-3 border shadow-lg">
                    ...
                    <div class="col-lg-7 p-3 p-lg-5 pt-lg-3 ovc-work-body-no-outline">
                        <button class="ovc-voice-select-btn">
                            <div class="voice-item-photo">
                                ...
                                <div class="voice-play-sel-button" data-link="">
                        ...
                        <div class="rounded ovc-setup overflow-auto" style="max-width: 500px; max-height: 250px;">
                            <section class="voice-item" data-id="patri" data-name="Patri">
                                ...
                                <button type="button" class="voice-play-button" data-link="voiceAudio/patri/006.wav">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-play-circle-fill" viewBox="0 0 16 16">
                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814z"/>
                                    </svg>
                                </button>
                            ...
                            <section class="voice-item" data-id="ex02" data-name="ex02">
                                ...
                                <button type="button" class="voice-play-button" data-link="voiceAudio/patri/011.wav">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-play-circle-fill" viewBox="0 0 16 16">
                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814z"/>
                                    </svg>
                                </button>
                            ...
                            <section class="voice-item" data-id="ex03" data-name="ex03">
                                ...
                                <button type="button" class="voice-play-button" data-link="voiceAudio/patri/017.wav">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-play-circle-fill" viewBox="0 0 16 16">
                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814z"/>
                                    </svg>
                                </button>
            ...
            <!--Preview & Dowload-->
            <section class="ovc-work-body-no-outline hide" id="download-body">
                <div class="container">
                    <div class="row">
                        <div class="col-4">
                            <div class="rounded ovc-setup border overflow-auto" style="max-width: 500px; max-height: 250px;">
                                ...
                                <section class="audio-item" data-link="voiceAudio/patri/011.wav">
                                    <div class="banner-audio-list-item-text">
                                        <p><b>011.wav</b></p>
                                    </div>
                                </section>
                                <section class="audio-item" data-link="voiceAudio/patri/017.wav">
                                    <div class="banner-audio-list-item-text">
                                        <p><b>017.wav</b></p>
                                    </div>
                                </section>
                            ...
                            <div class="p-3 d-flex justify-content-center">
                                <button class="mr-1 btn btn-dark" id="btn-download-all-files">Download all audio files</button>
                                <button class="ml-1 btn btn-light" id="btn-download-this-file">Download only this audio file</button>
                            </div>
                        </div>
                        
                        <div class="col-8">
                            <h2 id="fileName">006.wav</h2>
                            <p>click to pre-listening before download</p>
                            <div id="waveform"></div>
                        </div>
                    </div>
                </div>
